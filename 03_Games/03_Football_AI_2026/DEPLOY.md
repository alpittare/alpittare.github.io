# GoalBot — Deployment Guide

## Files Ready for Deploy (`dist/`)
```
dist/
├── index.html          ← Main game (PWA entry point)
├── goalbot-standalone.html  ← Standalone version (no PWA)
...
git init
git add dist/
git commit -m "GoalBot v1.0 — production build"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/goalbot.git
git push -u origin main
```

2. Go to https://vercel.com → Sign in with GitHub
3. Import your `goalbot` repo
4. Set **Root Directory** to `dist`
5. Click Deploy → Done!
6. Your game is live at `https://goalbot.vercel.app`
...
4. Save → Your game is at `https://YOUR_USERNAME.github.io/goalbot/`
...
npx cap init GoalBot com.yourname.goalbot --web-dir dist
...
2. Set Bundle Identifier: `com.yourname.goalbot`
